        ...
        <form action="{{ route('extra.update', ['extra' => $extraInfo->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <select id="for" name="for"
                    ...
                    <option value="doctor" @if ($extraInfo->for == 'doctor') selected @endif>Doctor</option>
                    <option value="hospital" @if ($extraInfo->for == 'hospital') selected @endif>Hospital</option>
                    <option value="surgery" @if ($extraInfo->for == 'surgery') selected @endif>Surgery & Support</option>
                    <option value="homeService" @if ($extraInfo->for == 'homeService') selected @endif>Home Service</option>
                    <option value="bloodClub" @if ($extraInfo->for == 'bloodClub') selected @endif>Blood Club</option>
                </select>
                @error('for')
                    <span class="text-red-700">{{ $message }}</span>
                @enderror
            ...
            <div class="mb-6" style="display: none">
                ...
                <select id="area" name="area_id"
                    ...
                    @foreach ($areas as $area)
                        <option value="{{ $area->id }}" @if ($extraInfo->area_id == $area->id) selected @endif>
                            {{ $area->name }}</option>
                    @endforeach
                </select>
                @error('area_id')
            ...
            <div class="mb-6" style="display: none">
                ...
                <select id="department" name="department_id"
                    ...
                    @foreach ($departments as $department)
                        <option value="{{ $department->id }}" @if ($extraInfo->department_id == $department->id) selected @endif>
            ...
            <div class="mb-6">
                ...
                <textarea id="short_description" type="textarea" name="short_description" rows="10" minHeight="500"
                    class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">{!! $extraInfo->short_description !!}</textarea>
            </div>
            <div class="mb-6">
                <label for="bn_short_description"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Bangla Short Description</label>
                <textarea id="bn_short_description" type="textarea" name="bn_short_description" rows="10" minHeight="500"
                    class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">{!! $extraInfo->bn_short_description !!}</textarea>
            </div>
            <div class="mb-6">
            ...
            <div class="mb-6">
                <label for="bn_description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Bangla
                    Description</label>
            ...
            <div class="mb-6">
                ...
                <input type="text" id="meta_title" name="meta_title"
                    class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                    placeholder="Enter title" value="{{ $extraInfo->meta_title }}">
            </div>
            <div class="mb-6">
                ...
                <input type="text" id="meta_keywords" name="meta_keywords"
                    class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                    placeholder="Enter keywords comma separated" value="{!! $extraInfo->meta_keywords !!}">
            </div>
            <div class="mb-6">
                ...
                <input type="text" id="meta_description" name="meta_description"
                    class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                    placeholder="Enter Description" {!! $extraInfo->meta_description !!}>
            </div>
            <button type="submit"
