                ...
                <div class="blog-view">
                    <div class="blog blog-single-post">
                        <div class="blog-image">
                            <a href="javascript:void(0);"><img alt="{{ $post->title }}" src="{{ asset('uploads/thumbnail/'.$post->thumbnail)}}"
                                    class="img-fluid"></a>
                        </div>
                        ...
                        <div class="blog-info clearfix">
                            <div class="post-left">
                                <ul>
                                    ...
                                    <li><i class="far fa-calendar"></i>{{ \Carbon\Carbon::parse($post->posted_at)->format("d M Y") }}</li>
